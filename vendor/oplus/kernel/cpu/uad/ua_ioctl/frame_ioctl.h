...
enum BoostStage {
	...
	BOOST_RT_QBUF_END = 218,
	BOOST_TD_APP_NOTIFY = 219,
	...
	BOOST_STAGE_VSYNC_TO_INPUT = 501,
	BOOST_STAGE_INPUT,
	BOOST_STAGE_ANIMATION,
	BOOST_STAGE_TRAVERSAL,
	BOOST_STAGE_DO_FRAME_END,
	BOOST_STAGE_DRAW_FRAME_START,
	BOOST_STAGE_DRAW_FRAME_END,
};
